-- Migración 084: Plantilla 360 Safe Mode (Sin tildes para evitar problemas de encoding)
-- Fecha: 2026-01-11
-- Encoding: UTF-8 (pero usando solo caracteres ASCII)

-- Borrar plantillas anteriores corruptas
DELETE FROM plantilla_inspeccion_360;

-- Insertar plantilla con encoding seguro (ASCII puro)
INSERT INTO plantilla_inspeccion_360 (tipo_unidad, nombre, descripcion, version, secciones, activa, creado_por)
VALUES (
    'DEFAULT',
    'Inspeccion 360 PROVIAL',
    'Formulario universal de inspeccion vehicular para todas las unidades',
    4,
    '[
        {
            ...
            "items": [
                ...
                {"codigo": "CB010", "descripcion": "Tapon de Gas", "tipo": "CHECKBOX", "requerido": true},
                ...
                {"codigo": "CB015", "descripcion": "Vidrios Electricos y/o manuales", "tipo": "CHECKBOX", "requerido": true},
        ...
        },
        {
            ...
            "items": [
                ...
                {"codigo": "NL002", "descripcion": "Aceite Hidraulico", "tipo": "ESTADO", "opciones": ["FULL", "MEDIO", "BAJO"], "requerido": true},
                {"codigo": "NL003", "descripcion": "Liquido de Frenos", "tipo": "ESTADO", "opciones": ["FULL", "MEDIO", "BAJO"], "requerido": true},
        ...
        },
        {
            ...
            "items": [
                ...
                {"codigo": "CI011", "descripcion": "Tapon de Combustible", "tipo": "ESTADO", "opciones": ["BUENO", "REGULAR", "MALO"], "requerido": true},
...
SELECT 'Plantilla 360 Safe Mode (Sin Tildes) Aplicada Correctamente' as resultado;
