-- ================================================
-- Migración 048: Fix vista v_situaciones_completas
-- Fecha: 2025-12-11
-- Descripción: Agregar salida_unidad_id a la vista
-- ================================================

-- Eliminar vistas dependientes
DROP VIEW IF EXISTS v_bitacora_unidad CASCADE;

-- Recrear vista principal con salida_unidad_id
...
COMMENT ON VIEW v_situaciones_completas IS 'Vista completa de situaciones con todos los datos relacionados, detalles y salida_unidad_id';
...
COMMENT ON VIEW v_bitacora_unidad IS 'Bitácora completa de situaciones por unidad con salida_unidad_id';
